<<<<<<< HEAD
export { default } from "../aitota-pages/Home";
=======
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12 md:gap-14 mb-12">
            ...
            <div className="flex flex-col items-center">
              <button className="w-20 h-20 lg:w-32 lg:h-32 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-400 transition-colors mb-2 glow-mic">
                <svg className="w-8 h-8 lg:w-12 lg:h-12 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            {/* Contact Form */}
            <form onSubmit={handleGetCall} className="flex flex-col gap-3 sm:gap-4 w-full max-w-md mx-auto lg:mx-0">
