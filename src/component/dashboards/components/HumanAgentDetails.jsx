...
const HumanAgentDetails = ({ agentId, onBack }) => {
  ...
  const fetchGroupContacts = async (group) => {
    ...
    try {
      ...
      const tokenResponse = await fetch(
        `${API_BASE_URL}/client/auth/human-agent-token/${agentId}`,
        {
      ...
      if (tokenData.success && tokenData.token) {
        ...
        const response = await fetch(
          `${API_BASE_URL}/human-agent/groups/${group._id}/contacts`,
          {
  ...
  const fetchAssignedGroups = async () => {
    try {
      ...
      if (tokenData.success && tokenData.token) {
        ...
        const response = await fetch(
          `${API_BASE_URL}/human-agent/groups?owner=assign`,
          {
            headers: { Authorization: `Bearer ${tokenData.token}` },
          }
        );
  ...
  const fetchAgentStats = async () => {
    try {
      ...
      if (tokenData.success && tokenData.token) {
        ...
        const response = await fetch(
          `${API_BASE_URL}/human-agent/agent-dispo-stats?humanAgentId=${agentId}`,
          {
            headers: { Authorization: `Bearer ${tokenData.token}` },
          }
        );
  ...
  const fetchDialsReport = async () => {
    try {
      ...
      if (tokenData.success && tokenData.token) {
        ...
        const response = await fetch(
          `${API_BASE_URL}/human-agent/dials/report${q ? `?${q}` : ""}`,
          {
            headers: { Authorization: `Bearer ${tokenData.token}` },
          }
        );
  ...
  const fetchDialsDone = async () => {
    try {
      ...
      if (tokenData.success && tokenData.token) {
        ...
        const q = buildDateQuery();
        const response = await fetch(
          `${API_BASE_URL}/human-agent/dials/done${q ? `?${q}` : ""}`,
          {
            headers: { Authorization: `Bearer ${tokenData.token}` },
          }
        );
  ...
  const fetchContactsForAgentGroup = async () => {
    ...
    try {
      ...
      const resp = await fetch(
        `${API_BASE_URL}/client/groups/${agent.groupId}/contacts`,
        {
  ...
  const fetchAvailableGroups = async () => {
    const token = sessionStorage.getItem("clienttoken");
    const resp = await fetch(`${API_BASE_URL}/client/groups`, {
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  const fetchContactsForGroup = async (groupId) => {
    ...
    const token = sessionStorage.getItem("clienttoken");
    const resp = await fetch(
      `${API_BASE_URL}/client/groups/${groupId}/contacts`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
  ...
  const handleSelectGroup = async (group) => {
    try {
      ...
      const token = sessionStorage.getItem("clienttoken");
      const resp = await fetch(`${API_BASE_URL}/client/groups/${group._id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
            ...
            <div className="flex gap-3 justify-end mt-2">
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  const token = sessionStorage.getItem("clienttoken");
                  await fetch(
                    `${API_BASE_URL}/client/groups/${selectedGroupId}/assign-contacts`,
                    {
                      method: "POST",
                      headers: {
                        Authorization: `Bearer ${token}`,
                      ...
                      <form
                        onSubmit={async (e) => {
                          ...
                          try {
                            ...
                            const token = sessionStorage.getItem("clienttoken");
                            const resp = await fetch(
                              `${API_BASE_URL}/client/groups/${selectedGroup._id}/contacts/bulk-add`,
                              {
                                method: "POST",
                                headers: {
                                  Authorization: `Bearer ${token}`,
                      ...
                      <button
                        ...
                        onClick={async () => {
                          try {
                            const token = sessionStorage.getItem("clienttoken");
                            const response = await fetch(
                              `${API_BASE_URL}/client/groups/${selectedGroup._id}/assign?owner=assign`,
                              {
                                method: "POST",
                                headers: {
                                  Authorization: `Bearer ${token}`,
